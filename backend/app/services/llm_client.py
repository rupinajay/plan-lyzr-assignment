...
class LLMClient:
    ...
    async def chat(self, messages: List[Dict[str, str]], model: str = "meta-llama/llama-guard-4-12b") -> Dict[str, Any]:
        """
    ...
    async def extract_json(self, messages: List[Dict[str, str]], schema_prompt: str, model: str = "meta-llama/llama-guard-4-12b", max_retries: int = 2) -> Dict[str, Any]:
        """
